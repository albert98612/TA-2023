...
<body class="hold-transition sidebar-mini">
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#inputnamasuplier').on('select2:select', function(e) {
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Input Pembelian Bahan Baku</h4>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="inputnamasuplier" class="col-sm-4 col-form-label">Nama Supplier</label>
            <div class="input-group col-sm-5">
              <select id="inputnamasuplier" class="form-control" style="width: 100%;"></select>
            </div>
            <!-- /.input group -->
          </div>
          <!-- /.form group -->
